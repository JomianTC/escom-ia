...
import { useWordByWord } from '@/pages/Private/Profesores/components/WordByWord'
            ...
            <Formik
              ...
              >
                ...
                <Form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                  {showComment && (
                    <>
                      <MyTextInput label="Comentario" name="comentario" type="text" placeholder="Escribe un comentario..." className='mt-4' />
