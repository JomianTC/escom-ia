...
export default function Loader ({ mainContainerStyles = '', bubbleContainerStyles = '' }) {
  return (
    <section className={`main__container flex items-center justify-center overflow-hidden relative  ${mainContainerStyles}`}>
    <div className={`relative w-64 h-64 md:w-fit md:h-fit mx-auto my-auto ${bubbleContainerStyles}`}>
